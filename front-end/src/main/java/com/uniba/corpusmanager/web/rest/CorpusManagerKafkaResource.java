...
import com.uniba.corpusmanager.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/corpus-manager-kafka")
public class CorpusManagerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CorpusManagerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CorpusManagerKafkaResource(KafkaProperties kafkaProperties) {
